...
namespace mc_veo{
    ...
    public:
         ...
         */
        Task(std::string const& name = "mc-veo::Task");
    ...
    protected:
        ...
        /** Events to Image Tracker. This is the mc-veo tracker**/
        bool eventsToImageAlignment(const std::vector<::base::samples::Event> &events_array, ::base::Transform3d &T_kf_ef);
        bool eventsToImageAlignment(const Eigen::Affine3d &pose_w_kf, const std::vector<::base::samples::Event> &events_array, ::base::Transform3d &T_kf_ef);
